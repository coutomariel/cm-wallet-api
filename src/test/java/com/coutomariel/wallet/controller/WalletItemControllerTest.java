...
import com.coutomariel.wallet.dto.WalletItemDTO;
...
public class WalletItemControllerTest {
	...
	public void testFindByType() throws Exception {
		...
		mvc.perform(MockMvcRequestBuilders.get(URL + "/type/1?type=ENTRADA").contentType(MediaType.APPLICATION_JSON)
	...
	public void testUpdate() throws Exception {
		...
		BDDMockito.given(service.save(Mockito.any(WalletItem.class)))
				.willReturn(new WalletItem(1L, w, DATE, description, TypeEnum.SD, VALUE));
	...
	public void testUpdateWalletChange() throws Exception {
		...
		WalletItem wi = new WalletItem(1L, w, DATE, DESCRIPTION, TypeEnum.SD, VALUE);
	...
	private WalletItem getMockWalletItem() {
		...
		WalletItem wi = new WalletItem(1L, w, DATE, DESCRIPTION, TYPE, VALUE);
		return wi;
	}
